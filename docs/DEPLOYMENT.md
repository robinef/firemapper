...
```
GitHub Actions ──┬─ refresh-fast (*/15)  MTG FRP, wind, re-cluster
...
|---|---|---|
| [`refresh-fast.yml`](../.github/workflows/refresh-fast.yml) | `*/15` | MTG FRP, wind, then re-clusters against the archive |
